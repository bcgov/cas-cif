...
NAMESPACE="c53ff1-dev" # Change this value to match the project's namespace-prefix and environment
declare -a APPS=("cif-documents" "cif-backups") # Change these to match the project's application bucket names
