...
import ProjectRevisionChangeLog from "components/Form/ProjectRevisionChangeLog";
...
const formPages: FormPageDefinition[] = [
  ...
  },
  {
    ...
    editComponent: ProjectRevisionChangeLog,
    viewComponent: ProjectRevisionChangeLog,
  },
];
