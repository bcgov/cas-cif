...
import { ProjectMilestoneReportsPage } from "pages/cif/project-revision/[projectRevision]/form/milestone-reports";
import PageTestingHelper from "tests/helpers/pageTestingHelper";
import compiledMilestoneReportsFormQuery, {
...
const pageTestingHelper = new PageTestingHelper<milestoneReportsFormQuery>({
  pageComponent: ProjectMilestoneReportsPage,
  compiledQuery: compiledMilestoneReportsFormQuery,
...
describe("The Project Milestone Reports page", () => {
  beforeEach(() => {
  ...
  it("renders the task list in the left navigation with correct highlighting", () => {
    ...
    const mockPathname =
      "/cif/project-revision/[projectRevision]/form/milestone-reports";
  ...
  it("redirects the user to the project revision page on submit", () => {
    ...
    let handleSubmit;
    jest
      .spyOn(require("components/Form/ProjectMilestoneReportForm"), "default")
