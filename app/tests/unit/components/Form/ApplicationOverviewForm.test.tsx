        ...
        input: {
          ...
          formChangePatch: {
            newFormData: {
              ...
              contractNumber: expect.anything(),
              totalFundingRequest: expect.anything(),
              projectStatusId: expect.anything(),
              operatorTradeName: expect.anything(),
              sectorName: expect.anything(),
      ...
      "updateProjectFormChangeMutation",
      {
        input: {
          ...
          formChangePatch: {
            newFormData: {
              projectName: "lalala2",
              fundingStreamRfpId: expect.anything(),
              proposalReference: expect.anything(),
              summary: expect.anything(),
              operatorId: expect.anything(),
              comments: expect.anything(),
