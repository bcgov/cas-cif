...
comment on function cif.form_change_holdback_amount_to_date(cif.form_change) is 'Computed column returns cumulative amount of the holdback amount reported up to and including this milestone.';
