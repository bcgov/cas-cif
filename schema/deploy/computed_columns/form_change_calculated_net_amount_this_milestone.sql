...
comment on function cif.form_change_calculated_net_amount_this_milestone(fc cif.form_change) is 'Computed column returns the calculated net payment amount for a particular milestone based on the adjusted or calculated holdback amount and adjusted or calculated gross amount for the milestone with priority given to the adjusted amounts.';
