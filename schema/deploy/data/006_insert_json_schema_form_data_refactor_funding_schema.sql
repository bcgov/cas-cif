-- Deploy cif:data/006_insert_json_schema_form_data_refactor_funding_schema to pg


begin;

delete from cif.form where slug='additional_funding_source';
delete from cif.form where slug='funding_agreement';
