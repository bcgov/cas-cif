...
delete from cif.project_status where name in ('Funding Offered', 'Agreement Signed', 'Advanced Milestone Complete', 'Performance Milestone Complete', 'Complete', 'Under Review');
