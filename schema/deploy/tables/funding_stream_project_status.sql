...
comment on column cif.funding_stream_project_status.position is 'Defines a way to order the project statuses';

--EP and IA statuses
insert into cif.funding_stream_project_status (funding_stream_id, project_status_id, position)
values
