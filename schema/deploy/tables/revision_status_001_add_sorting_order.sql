...
update cif.revision_status set sorting_order = 1 where name = 'Pending Province Approval';
update cif.revision_status set sorting_order = 2 where name = 'Pending Proponent Signature';
update cif.revision_status set sorting_order = 3 where name = 'Applied';
