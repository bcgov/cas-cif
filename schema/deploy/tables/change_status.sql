...
create table cif.change_status (
  ...
  triggers_commit boolean default false,
...
comment on column cif.change_status.triggers_commit is 'Whether that status should trigger a commit of the record described by the change';
