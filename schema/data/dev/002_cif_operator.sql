...
('{
  ...
  "operatorCode": "ABCD" }', 'create', 'cif', 'operator', 'committed', 'Created by dev data seed script', 'operator'),
('{
  ...
  "operatorCode": "EFGH" }', 'create', 'cif', 'operator', 'committed', 'Created by dev data seed script', 'operator'),
('{
  ...
  "operatorCode": "IJKL" }', 'create', 'cif', 'operator', 'committed', 'Created by dev data seed script', 'operator');
