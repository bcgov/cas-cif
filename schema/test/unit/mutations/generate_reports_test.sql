  ...
  $$
    values (
      ...
      format(
        ...
        to_char(date_trunc('day', '2022-01-31'::timestamptz) + interval '1 day' - interval '1 second', 'YYYY-MM-DD"T"HH24:MI:SSTZH:TZM')
      )::jsonb,
    ...
    (
      ...
      format(
        ...
        to_char(date_trunc('day', '2023-01-31'::timestamptz) + interval '1 day' - interval '1 second', 'YYYY-MM-DD"T"HH24:MI:SSTZH:TZM')
      )::jsonb,
      'create'::cif.form_change_operation,
      'cif'::varchar,
      'reporting_requirement'::varchar,
    ...
    (
      ...
      format(
        ...
        to_char(date_trunc('day', '2024-01-31'::timestamptz) + interval '1 day' - interval '1 second', 'YYYY-MM-DD"T"HH24:MI:SSTZH:TZM')
      )::jsonb,
      'create'::cif.form_change_operation,
      'cif'::varchar,
      'reporting_requirement'::varchar,
    ...
    (
      ...
      format(
        ...
        to_char(date_trunc('day', '2025-01-31'::timestamptz) + interval '1 day' - interval '1 second', 'YYYY-MM-DD"T"HH24:MI:SSTZH:TZM')
      )::jsonb,
      'create'::cif.form_change_operation,
      'cif'::varchar,
      'reporting_requirement'::varchar,
