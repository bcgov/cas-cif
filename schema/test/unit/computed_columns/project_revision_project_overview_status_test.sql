...
select is(
  (
    select cif.project_revision_project_overview_status((select row(project_revision.*)::cif.project_revision from cif.project_revision where id=1))
  ),
  'Incomplete',
...
select is(
  (
    select cif.project_revision_project_overview_status((select row(project_revision.*)::cif.project_revision from cif.project_revision where id=2))
  ),
  'Not Started',
