...
select is (
  ...
  4::integer,
  'returns the pending project revision for the project when there is a previous committed revision'
);
...
select is (
  ...
  3::integer,
  'returns the pending project revision for the project when there is no previous committed revision'
);
...
select is (
  ...
  null,
  'returns null when there is no pending project revision for the project'
);
