...
'create', 'cif', 'funding_parameter', 'pending', 'funding_parameter_EP', 4);
/** END SETUP **/
...
select is(
  ...
  null,
  'Returns null as there is a funding source with status of Awaiting Approval'
);
...
select is(
  ...
  356000::numeric,
  'Returns sum of proponent cost and max funding amount when additional funding sources are either denied or approved'
);
