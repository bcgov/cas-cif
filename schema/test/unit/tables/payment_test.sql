...
insert into cif.reporting_requirement
  (report_due_date, status, comments, certified_by, certified_by_professional_designation, project_id, report_type, reporting_requirement_index)
  values ('2020-01-01', 'on_track', 'comment_1', 'certifier_1', 'certifier_1', 1, 'Annual', 1);
