...
select lives_ok(
  $$
    select cif_private.verify_policy('select', 'select_test', 'test_table', 'test_role');
  $$,
...
select lives_ok(
  $$
    select cif_private.verify_policy('insert', 'insert_test', 'test_table', 'test_role');
  $$,
...
select lives_ok(
  $$
    select cif_private.verify_policy('update', 'update_test', 'test_table', 'test_role');
  $$,
...
select lives_ok(
  $$
    select cif_private.verify_policy('delete', 'delete_test', 'test_table', 'test_role');
  $$,
...
select lives_ok(
  $$
    select cif_private.verify_policy('all', 'all_test', 'test_table', 'test_role');
  $$,
...
select throws_ok(
  $$
    select cif_private.verify_policy('bubbles', 'select_test', 'test_table', 'test_role');
  $$,
  'P0001',
...
select throws_ok(
  $$
    select cif_private.verify_policy('insert', 'select_test', 'test_table', 'test_role');
  $$,
  'P0001',
...
select throws_ok(
  $$
    select cif_private.verify_policy('select', 'bubbles', 'test_table', 'test_role');
  $$,
  'P0001',
...
select throws_ok(
  $$
    select cif_private.verify_policy('select', 'select_test', 'not_a_table', 'test_role');
  $$,
  '42P01',
  'relation "cif.not_a_table" does not exist',
  'Function verify_policy throws if table name does not exist in policy'
);

select throws_ok(
  $$
    select cif_private.verify_policy('select', 'select_test', 'test_table', 'not_a_role');
  $$,
  'P0001',
