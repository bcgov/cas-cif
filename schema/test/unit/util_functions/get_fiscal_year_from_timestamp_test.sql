...
select is((select cif.get_fiscal_year_from_timestamp('2000-03-01 16:21:42.693489-07')), '1999/2000');
select is((select cif.get_fiscal_year_from_timestamp('2000-04-01 16:21:42.693489-07')), '2000/2001');
